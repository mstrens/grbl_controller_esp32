...
#define MY_PASSWORD "your password" // replace by the password of your access point (when act as station) or the password you want to use to protect your ESP32 (when act as acces point)
