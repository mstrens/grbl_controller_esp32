...
#define TOUCH_CS 27    //26 //21     // Chip select pin (T_CS) of touch screen
#define TOUCH_IMPROVED
//#define TOUCH_IRQ 27 // added by Michel Strens
...
#define SPI_TOUCH_FREQUENCY  2500000 // initialement 2500000
